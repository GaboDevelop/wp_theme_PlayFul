<?php
/**
 * playful functions and definitions
 *
...
if ( ! function_exists( 'pf_setup' ) ) :
	...
	function pf_setup() {
		 ...
		 * If you're building a theme based on playful, use a find and replace
...
function pf_scripts() {
	...
	wp_enqueue_script( 'pf-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'pf-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
